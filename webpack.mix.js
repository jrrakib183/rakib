...
if (process.env.NODE_ENV === 'development' || process.env.NODE_ENV === 'production') {
    ...
    mix.js('src/js/main.js', `dist/assets/js/main${min}.js`)
        ...
        .sass('src/scss/invoice.scss', `dist/assets/css/invoice${min}.css`).sourceMaps()
        .sass('src/scss/invoice-single.scss', `dist/assets/css/invoice-single${min}.css`).sourceMaps()
        .sass('src/scss/sidebar.scss', `dist/assets/css/sidebar${min}.css`).sourceMaps()
        .sass('src/scss/common.scss', `dist/assets/css/common${min}.css`).sourceMaps()
        .njk('src/html', 'dist/', {
            ext: '.html',
            marked: null,
            watch: true,
